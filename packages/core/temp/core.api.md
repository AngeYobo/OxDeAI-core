...
// @public
export function isTrustedAuthorizationAuthority(authorities: readonly AuthorizationAuthority[], issuer: string, policyId: string): boolean;
